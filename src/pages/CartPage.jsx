  ...
  if (items.length === 0) {
    return (
      <EmptyState
        ...
        subtitle="Start adding some delicious items!"
        action={
          <button onClick={() => navigate('/home')} className="bg-gradient-to-r from-orange-500 to-pink-500 text-white px-6 py-2 rounded-lg font-medium">
            Start Shopping
          </button>
        }
      />
